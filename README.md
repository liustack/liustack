...
I build enterprise-grade AI platforms — from GPU scheduling (K8s/Volcano) to LLM serving (vLLM/SGLang), RAG pipelines, and Agent orchestration. On the frontend side, I ship with React, Next.js, and Astro.
